app_ejemplo <- function(...) {
  ui <- bslib::page_fluid(
    bslib::navset_card_underline(
      nav_panel("Panel 1", seleccion_ui("mod1"), plotOutput("plot1")), # Llama al módulo en la UI
      nav_panel("Panel 2", seleccion_ui("mod2"), reactableOutput("tabla2")) # Llama al
    )
  )
